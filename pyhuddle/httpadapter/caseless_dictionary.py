...
pair as the key's value (values become dictionaries)."""
    ...
    """
    http response headers are case insensitive so if your library returns them as upper case the key search will error in our library
    as we look for lower case headers e.g. location not Location. Wrap your headers in this dictionary to ensure they are lower case
    """
