...
from api.hyperlinkresource import HyperLinkResource

__author__ = 'adam.flax'

class WhenWeGetAHyperLinkResource(unittest.TestCase):
    def setUp(self):
        self.result = HyperLinkResource(self.jsonData())

    def test_makeSureWeCanGetSelfLink(self):
        self.assertEqual("http://api.huddle.dev/files/folders/2227259", self.result.selfLink)

    def test_makeSureWeCanGetIndex(self):
        self.assertEqual(5, self.result.getLinkIndex("share"))

    def test_makeSureWeCanFindParentLink(self):
        self.assertEqual("http://api.huddle.dev/files/folders/2227259", self.result.getLink("parent"))
